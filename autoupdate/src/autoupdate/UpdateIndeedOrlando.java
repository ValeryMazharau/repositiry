...
public class UpdateIndeedOrlando {
    FirefoxDriver wd;
    ...
    public void f()  {
        ...
        wd.findElement(By.id("signin_email")).sendKeys("mazharau.valery+6@gmail.com");
        ...
        wd.findElement(By.xpath("//div[@class='nav-bar']//div[.='mazharau.valery+6@gmail.com']")).click();
        wd.findElement(By.linkText("Sign out")).click();

        System.out.println("UpDate Indeed Miami done"); 
    }
