...
public class UpdateIndeedMiami {
    FirefoxDriver wd;
    ...
    public void f()  {
        ...
        wd.findElement(By.id("signin_email")).sendKeys("mazharau.valery+2@gmail.com");
        ...
        wd.findElement(By.xpath("//div[@class='nav-bar']//div[.='mazharau.valery+2@gmail.com']")).click();
