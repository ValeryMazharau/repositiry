...
public class UpdateDiceOrlando {
	 FirefoxDriver wd;
	 @BeforeMethod
  ...
  public void m() {
      ...
      wd.findElement(By.id("email")).sendKeys("mazharau.valery+6@gmail.com");
      ...
      wd.findElement(By.linkText("Valery Mazhara")).click();
      wd.findElement(By.cssSelector("button.btn.btn-link")).click();
	  
	 
      System.out.println("UpDate Dice Orlando done"); 
  }
